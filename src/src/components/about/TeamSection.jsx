  ...
  const team = [
    {
      ...
      bio: "Responsável pela arquitetura do sistema, desenvolvimento do backend e integração com banco de dados. Implementou o sistema de autenticação e gerenciamento de cursos.",
      avatar:
        "",
    ...
    },
    {
      ...
      bio: "Criou toda a identidade visual do projeto, wireframes e protótipos. Desenvolveu os componentes React e garantiu a responsividade da plataforma.",
      avatar:
        "",
      skills: ["Figma", "React", "TailwindCSS", "Design Systems"],
      github: "https://github.com",
      linkedin: "https://linkedin.com",
    },
    {
      ...
      bio: "Realizou a pesquisa de mercado, coleta de dados sobre cursos e instituições. Responsável pela documentação técnica e análise de requisitos do projeto.",
      avatar:
        "",
      skills: ["Pesquisa", "Documentação", "SQL", "Análise de Dados"],
      github: "https://github.com",
      linkedin: "https://linkedin.com",
    },
  ];
