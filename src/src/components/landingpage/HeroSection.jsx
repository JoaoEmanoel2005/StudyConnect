            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative">
                ...
                <div ref={imageRef} className="relative">
                  ...
                  <div className="absolute -top-6 -right-4 bg-white rounded-full p-4 shadow-xl border-4 border-slate-900">
                    <div className="text-center">
                      <TrophyIcon className="h-8 w-8 text-amber-500 mx-auto mb-1" />
                      <div className="text-xs font-bold text-slate-900">TOP</div>
                      <div className="text-xs text-slate-600">Ranqueado</div>
                    </div>
                  </div>
                </div>
...
const StatCard = ({ icon: Icon, value, label, color }) => (
  <div className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-lg hover:shadow-white/5">
    <div className={`inline-flex p-2 rounded-lg bg-${color} mb-3 group-hover:scale-110 transition-transform duration-300`}>
