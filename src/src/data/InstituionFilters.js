  ...
  return [
    {
      ...
      name: "Tipo",
      type: "checkbox",
      description: "Filtre por instituição pública ou privada",
    ...
    },
    {
      ...
      type: "checkbox",
      description: "Áreas temáticas oferecidas pela instituição",
      options: mapToOptions(counts.area),
    },
    {
      id: "preco",
      name: "Custo de Matrícula",
      type: "radio",
      description: "Agrupado em faixas para facilitar busca",
